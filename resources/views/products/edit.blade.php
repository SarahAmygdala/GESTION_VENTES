    ...
    <div class="max-w-4xl mx-auto pb-24 md:pb-6" x-data="{ show: false }" x-init="setTimeout(() => show = true, 50)">
        ...
        <div class="flex items-center justify-between mb-4 md:mb-6" x-show="show"
            ...
            <div class="flex items-center space-x-3 md:space-x-4">
                ...
                <div>
                    <h2 class="text-lg md:text-xl font-bold text-slate-900 tracking-tight line-clamp-1">Modifier :
                        {{ $product->name }}</h2>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-4 md:space-y-6" x-show="show"
                ...
                <div class="bg-white p-5 md:p-8 rounded-2xl border border-slate-200 shadow-sm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                        ...
                        <!-- Stock actuel -->
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-1.5">Stock actuel <span
                                    class="text-red-500">*</span></label>
                            <input type="number" inputmode="numeric" name="stock"
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-slate-700 mb-1.5">Alerte stock minimum <span
                                    class="text-red-500">*</span></label>
                            <input type="number" inputmode="numeric" name="min_stock"
                                ...
                                @if ($product->image)
                                    <div class="relative group h-20 w-20 flex-shrink-0">
                                        <img src="{{ asset('storage/' . $product->image) }}"
                                            class="h-20 w-20 object-cover rounded-xl shadow-sm border border-slate-200">
                                    </div>
                                @endif
